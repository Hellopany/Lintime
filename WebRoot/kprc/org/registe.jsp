...
<body id="schools">
 ...
 <div class="container">
    ...
    <form class="form-horizontal" action="save.html" namespace="/" method="post">
        <div class="form-group">
            <label class="col-sm-4 control-label" for="name"><span style="color:red;">*</span>单位名称</label>
            <div class="col-sm-4">
                <input type="text" class="form-control" name="member.name" data-validation="length" data-validation-length="5-255" data-validation-error-msg="字数范围在(5-255)"/>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-4 control-label" for="name"><span style="color:red;">*</span>联系电话</label>
            <div class="col-sm-4">
                <input type="text" class="form-control" name="member.telphone" data-validation="length" data-validation-length="1-50" data-validation-error-msg="字数范围在(1-50)"/>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <div class="col-sm-4 col-sm-offset-4">
                <button type="submit" onclick="return check()" class="btn btn-primary" ><i class="glyphicon glyphicon-ok"></i> 注册</button>
            </div>
        </div>
    </form>
</div>
