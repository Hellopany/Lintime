 ...
 <%--    <s:hidden name="studentEducation.studentid"></s:hidden>
    ...
    <s:hidden name="studentHonor.studentid"></s:hidden> --%>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="student.idcard"  onblur="getBirthday(this)"  value="${student.idcard }"  data-validation="sfz" data-validation-error-msg="身份证输入错误"/>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                   <input type="text" class="form-control" name="student.originaddress" value="${student.originaddress }" data-validation="length" data-validation-length="1-50" data-validation-error-msg="字数在1-50之间"/>
                </div>
         ...
         <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6 form-inline">
                    <input type="date" id="rx_from" class="form-control" name="studentSchoolRoll.joindate"  value="<s:date name="studentSchoolRoll.joindate" format="yyyy-MM-dd" />" data-validation="length" data-validation-length="2-200" data-validation-optional="false"  data-validation-error-msg="必选"/>
...
<footer th:fragment="footer">
	...
	function prese(){
		...
		$('#form1').attr("action", '<s:url action="update" namespace="/kprc/school" />');
		$('#form1').submit();
	}
	function isValid(){
