...
<body id="sigin">
	<main>
 	<div class="container-fluid">
		...
		<s:form class="form-signin" action="memberlogin"  namespace="/">
		<table border="0" align="center" cellpadding="0" cellspacing="0" style="color:#666666">
            <tbody>
<!--               <tr> -->
<!--                 <td colspan="2">我是用人单位，没有账号？<s:a action="registe" namespace="/">立即注册</s:a>！</td> -->
<!--               </tr> -->
              <tr>
                <td nowrap="nowrap">我是</td>
                <td><select id="usertype" name="systype" >
              ...
              <tr>
                ...
                <div style="width:234px;border:1px solid #cccccc; margin-top:5px;">
                    <div class="float_left">
                      <input name="member.name" type="text"  placeholder="请输入用户名" style="padding-left:5px;padding-right:5px;width:200px;height:32px;border:0;line-height:32px;font-size:14px;" />
                    </div>
              ...
              <tr>
                ...
                <div style="width:234px;border:1px solid #cccccc; margin-top:5px;">
                    <div class="float_left">
                      <input name="member.password"  type="password" placeholder="请输入用户密码" style="padding-left:5px;padding-right:5px;width:200px;height:32px;border:0;line-height:32px;font-size:14px;"/>
                    </div>
              ...
              <tr>
                <td height="60">&nbsp;</td>
                <td align="right">忘记密码？<a href="<%=path %>/forgetPass.html" target="_blank">请点此获取</a></td>
              </tr>
              <tr>
