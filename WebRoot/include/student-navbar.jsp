		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li><s:a action="studentindex" namespace="/">首页</s:a></li>
					<li><s:a action="list" namespace="/kprc/advertise">招聘信息</s:a></li>
					<li><s:a action="recvlist" namespace="/messages">消息中心</s:a></li>
					<li><s:a action="detail" namespace="/kprc/student">个人资料</s:a></li>
				</ul>
